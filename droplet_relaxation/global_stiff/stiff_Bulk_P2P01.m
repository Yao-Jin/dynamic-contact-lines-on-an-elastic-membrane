...
%% ----------------------------------------------------------------------------
    ...
    elem2edge = geom.elem2edge; inout = geom.inout;
    
    node(geom.mem2node,2) = sln.pmem(1:para.Nmem,2);
%% ---------------------------------------------------------------------------
    % read model parameters
    eta1 = para.eta1; eta2 = para.eta2; 
...
%% ---------------------------------------------------------------------------
    ...
    stiff_bulk.B21 = sparse(i21,j21,s21,N+Nt,N+Ne);
    stiff_bulk.B22 = sparse(i22,j22,s22,N+Nt,N+Ne);
