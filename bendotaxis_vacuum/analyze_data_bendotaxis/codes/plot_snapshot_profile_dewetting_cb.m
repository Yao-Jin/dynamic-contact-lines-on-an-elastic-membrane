...
for readdata = 1:1
load('dewetting_20_10_gap_4_xl_2_gamma2_0_3_cb_3e3_Ca_0_1.mat');
...
load('dewetting_20_10_gap_4_xl_2_gamma2_0_3_cb_7e3_Ca_0_1.mat');
...
load('dewetting_20_10_gap_4_xl_2_gamma2_0_3_cb_9e3_Ca_0_1.mat');
...
ind2 = floor(T/0.01)+1; %ind1 = floor(T/0.04)+1;
 
% axis tight;
% axis off;
% plot([0 para.Bx], [0 0],'--k','LineWidth',1.0); 

if ind2<lim1
    plot(pmem1(ind2,1:Nmem1(ind2),1),pmem1(ind2,1:Nmem1(ind2),2),'-.','color',c1,'LineWidth',3.0);
else
...
if ind2<lim2
    plot(pmem2(ind2,1:Nmem2(ind2),1),pmem2(ind2,1:Nmem2(ind2),2),'--','color',c2,'LineWidth',3.0);
else
    plot(pmem2(lim2,1:Nmem2(lim2),1),pmem2(lim2,1:Nmem2(lim2),2),'--','color',c2,'LineWidth',3.0);
end    
    
if ind2<lim3
    plot(pmem3(ind2,1:Nmem3(ind2),1),pmem3(ind2,1:Nmem3(ind2),2),':','color',c3,'LineWidth',3.0);
else
    plot(pmem3(lim3,1:Nmem3(lim3),1),pmem3(lim3,1:Nmem3(lim3),2),':','color',c3,'LineWidth',3.0);
end   

if ind2<lim4
    plot(pmem4(ind2,1:Nmem4(ind2),1),pmem4(ind2,1:Nmem4(ind2),2),'-','color',c4,'LineWidth',3.0);
else
...
if ind2<lim1
    plot(pmem1(ind2,1:Nmem1(ind2),1),-pmem1(ind2,1:Nmem1(ind2),2),'-.','color',c1,'LineWidth',3.0);
    plot(pffil1(ind2,1:Nffil1(ind2),1),pffil1(ind2,1:Nffil1(ind2),2),'-.','color',c1,'LineWidth',3.0);
    plot(pffil1(ind2,1:Nffil1(ind2),1),-pffil1(ind2,1:Nffil1(ind2),2),'-.','color',c1,'LineWidth',3.0);
    plot(pffir1(ind2,1:Nffir1(ind2),1),pffir1(ind2,1:Nffir1(ind2),2),'-.','color',c1,'LineWidth',3.0);
    plot(pffir1(ind2,1:Nffir1(ind2),1),-pffir1(ind2,1:Nffir1(ind2),2),'-.','color',c1,'LineWidth',3.0);
else
    plot(pmem1(lim1,1:Nmem1(lim1),1),-pmem1(lim1,1:Nmem1(lim1),2),'-.','color',c1,'LineWidth',3.0);
...
if ind2<lim2
    plot(pmem2(ind2,1:Nmem2(ind2),1),-pmem2(ind2,1:Nmem2(ind2),2),'--','color',c2,'LineWidth',3.0);
    plot(pffil2(ind2,1:Nffil2(ind2),1),pffil2(ind2,1:Nffil2(ind2),2),'--','color',c2,'LineWidth',3.0);
    plot(pffil2(ind2,1:Nffil2(ind2),1),-pffil2(ind2,1:Nffil2(ind2),2),'--','color',c2,'LineWidth',3.0);
    plot(pffir2(ind2,1:Nffir2(ind2),1),pffir2(ind2,1:Nffir2(ind2),2),'--','color',c2,'LineWidth',3.0);
    plot(pffir2(ind2,1:Nffir2(ind2),1),-pffir2(ind2,1:Nffir2(ind2),2),'--','color',c2,'LineWidth',3.0);
else
    plot(pmem2(lim2,1:Nmem2(lim2),1),-pmem2(lim2,1:Nmem2(lim2),2),'--','color',c2,'LineWidth',3.0);
...
if ind2<lim3
    plot(pmem3(ind2,1:Nmem3(ind2),1),-pmem3(ind2,1:Nmem3(ind2),2),':','color',c3,'LineWidth',3.0);
    plot(pffil3(ind2,1:Nffil3(ind2),1),pffil3(ind2,1:Nffil3(ind2),2),':','color',c3,'LineWidth',3.0);
    plot(pffil3(ind2,1:Nffil3(ind2),1),-pffil3(ind2,1:Nffil3(ind2),2),':','color',c3,'LineWidth',3.0);
    plot(pffir3(ind2,1:Nffir3(ind2),1),pffir3(ind2,1:Nffir3(ind2),2),':','color',c3,'LineWidth',3.0);
    plot(pffir3(ind2,1:Nffir3(ind2),1),-pffir3(ind2,1:Nffir3(ind2),2),':','color',c3,'LineWidth',3.0);
else
    plot(pmem3(lim3,1:Nmem3(lim3),1),-pmem3(lim3,1:Nmem3(lim3),2),':','color',c3,'LineWidth',3.0);
...
if ind2<lim4
    plot(pmem4(ind2,1:Nmem4(ind2),1),-pmem4(ind2,1:Nmem4(ind2),2),'-','color',c4,'LineWidth',3.0);
    plot(pffil4(ind2,1:Nffil4(ind2),1),pffil4(ind2,1:Nffil4(ind2),2),'-','color',c4,'LineWidth',3.0);
    plot(pffil4(ind2,1:Nffil4(ind2),1),-pffil4(ind2,1:Nffil4(ind2),2),'-','color',c4,'LineWidth',3.0);
    plot(pffir4(ind2,1:Nffir4(ind2),1),pffir4(ind2,1:Nffir4(ind2),2),'-','color',c4,'LineWidth',3.0);
    plot(pffir4(ind2,1:Nffir4(ind2),1),-pffir4(ind2,1:Nffir4(ind2),2),'-','color',c4,'LineWidth',3.0);
else
    plot(pmem4(lim4,1:Nmem4(lim4),1),-pmem4(lim4,1:Nmem4(lim4),2),'-','color',c4,'LineWidth',3.0);
...
% hh = legend({'$\cos\theta_Y=-0.9$','$\cos\theta_Y=-0.7$',...
%                 '$\cos\theta_Y=-0.5$','$\cos\theta_Y=-0.3$'},'Interpreter','latex');
% set(hh,'FontName','Times New Roman','FontSize',32,'FontWeight','normal','Orientation','horizontal');

% title(['t = ',num2str((ind2-1)*0.08)]);
